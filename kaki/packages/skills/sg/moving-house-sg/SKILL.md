...
when_to_use: Use when the household asks Kaki to handle moving house singapore.
...
3. Stop at the final `account.change` boundary with exact evidence; continue only with a scoped, unexpired approval.
